            ...
            try{
                ...
                if(msg.result.error_code == 0){
                    ...
                    Swal.fire({
                        type: 'error',
                        title: 'Oops!',
                        html: '<span style="color: #ff9900;">Error event booking </span>' + msg.result.error_msg,
                    }).then((result) => {
                        if (result.value) {
                            hide_modal_waiting_transaction();
                        }
...
function update_service_charge(type){
    ...
    if(type == 'booking'){
        ...
        for(i in event_get_detail.result.response.passengers){
            ...
            list_price = []
            if(document.getElementById(event_get_detail.result.response.passengers[i].name+'_repricing').innerHTML != '-'){
                list_price.push({
    ...
    <div class="row">
        <div class="col-lg-12" style="margin-bottom:15px;" id="share_result">
            ...
            if (isMobile) {
                ...
                text+=`
                    <a href="mailto:?subject=This is the event price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/images/logo/apps/email.png" alt="Email"/></a>`;
            } else {
                text+=`
                    <a href="https://web.whatsapp.com/send?text=`+ $text_share +`" data-action="share/whatsapp/share" title="Share by Whatsapp" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/images/logo/apps/whatsapp.png" alt="Whatsapp"/></a>`;
                if(option_number < 11){
