...
function sentra_medika_get_booking(order_number, sync=false){
    ...
    //                    document.getElementById('new-reservation').hidden = false;
                        ...
                        if(msg.result.response.state == 'booked'){
                           check_payment_payment_method(msg.result.response.order_number, 'Issued', msg.result.response.booker.seq_id, 'billing', 'sentramedika', signature, msg.result.response.payment_acquirer_number, msg);
