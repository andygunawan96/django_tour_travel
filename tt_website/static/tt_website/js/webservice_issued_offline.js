                        ...
                        <div class="col-lg-12" style="padding-bottom:10px;">
                            ...
                            if (isMobile) {
                                text_detail+=`
                                    ...
                                    <a href="mailto:?subject=This is the issued offline price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/email.png" alt="Email"/></a>`;
                            } else {
                                text_detail+=`
