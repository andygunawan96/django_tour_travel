                ...
                if(type == 'admin'){
                    ...
                    if(payment_partner.length != 0){
                        if(template == 1){
                            ...
                            text+=`<hr/><h4 style="color:black; margin-bottom:15px;">Payment Partner</h4>`;
                        }else if(template == 7){
                            text+=`<hr/><h4 style="color:black;">Payment Partner</h4>`;
                        }else if(template == 8){
                            text+=`<hr/><h4 style="color:black;">Payment Partner</h4>`;
                        }
                    }
...
function change_payment_partner(){
    ...
    if(partner_number != -1){
        ...
        document.getElementById("partner_img").src = '/static/tt_website/images/no pic/no-image-available.jpg';
