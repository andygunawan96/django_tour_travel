...
//        grand_total_option += upsell_price;
        ...
        for(i in upsell_price_dict){
            ...
            total_commission += upsell_price_dict[i];
        }
    }catch(err){
    ...
    text += `<div class="col-lg-12" style="padding-bottom:15px;">
        ...
        if (isMobile) {
            text+=`
                ...
                <a href="mailto:?subject=This is the event price detail&amp;body=`+ $text_share2 +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/email.png" alt="Email"/></a>`;
        } else {
            text+=`
...
function check_passenger(adult, child){
    ...
    length_name = event_carriers[event_pick['provider_code']].adult_length_name;
    error_log = '';
    try{
