    ...
    <div class="row">`;
        if(hotel_data_print.images.length != 0){
            ...
            <div class="col-lg-3 mb-2 mt-2">
                <div class="img-hotel-search" style="cursor:pointer; background-image: url('`+hotel_data_print.images[0].url+`');" onclick="goto_detail('hotel',`+i+`)"></div>
            </div>`;
        }
        else{
            text+=`
...
//        }
    ...
    <div class="row" style="padding-top:10px;">
        <div class="col-lg-12">
            ...
            if (isMobile) {
                text_pick_footer+=`
                    <a href="https://wa.me/?text=`+ $text_share2 +`" data-action="share/whatsapp/share" title="Share by Whatsapp" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/whatsapp.png" alt="Whatsapp"/></a>
                    <a href="line://msg/text/`+ $text_share2 +`" target="_blank" title="Share by Line" style="padding-right:5px;"><img style="height:30px; width:auto;" src="/static/tt_website/img/line.png" alt="Line"/></a>
                    <a href="https://telegram.me/share/url?text=`+ $text_share2 +`&url=Share" title="Share by Telegram" style="padding-right:5px;"  target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/telegram.png" alt="Telegram"/></a>
                    <a href="mailto:?subject=This is the hotel price detail&amp;body=`+ $text_share2 +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/email.png" alt="Email"/></a>`;
            } else {
                text_pick_footer+=`
                    <a href="https://web.whatsapp.com/send?text=`+ $text_share2 +`" data-action="share/whatsapp/share" title="Share by Whatsapp" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/whatsapp.png" alt="Whatsapp"/></a>
                    <a href="https://social-plugins.line.me/lineit/share?text=`+ $text_share2 +`" title="Share by Line" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/line.png" alt="Line"/></a>
                    <a href="https://telegram.me/share/url?text=`+ $text_share2 +`&url=Share2" title="Share by Telegram" style="padding-right:5px;"  target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/telegram.png" alt="Telegram"/></a>
                    <a href="mailto:?subject=This is the hotel price detail&amp;body=`+ $text_share2 +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/email.png" alt="Email"/></a>`;
            }
            text_pick_footer +=`
            <div style="float:right;">
                <button class="primary-btn-white" style="width:150px;" type="button" onclick="copy_data2();">
...
//    if(currency_rate_data.result.response.agent.hasOwnProperty(user_login.agent_name)){ // buat o3
    ...
    if(document.URL.split('/')[document.URL.split('/').length-1] == 'review' && user_login.co_agent_frontend_security.includes('b2c_limitation') == false && user_login.co_agent_frontend_security.includes("corp_limitation") == false){
        text+=`<div class="row"><div class="col-lg-12"><div style="text-align:right;"><img src="/static/tt_website/img/bank.png" alt="Bank" style="width:auto; height:25px; cursor:pointer;" onclick="show_repricing();"/></div></div></div>`;
    }
...
function get_checked_copy_result(){
    ...
    <div class="col-lg-12" id="share_result">
        ...
        if (isMobile) {
            ...
            text_footer+=`
                <a href="mailto:?subject=This is the hotel price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/email.png" alt="Email"/></a>`;
        } else {
            text_footer+=`
            ...
            if(hotel_number < 11){
                ...
                text_footer+=`
                <a href="#" title="Share by Line" style="padding-right:5px; cursor:not-allowed;"><img style="height:30px; width:auto;" src="/static/tt_website/img/line-gray.png"/></a>
                <a href="#" title="Share by Telegram" style="padding-right:5px; cursor:not-allowed;"><img style="height:30px; width:auto;" src="/static/tt_website/img/telegram-gray.png"/></a>`;
            }
            text_footer+=`
                <a href="mailto:?subject=This is the hotel price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" src="/static/tt_website/img/email.png" alt="Email"/></a>`;
        }
...
function render_hotel_search_detail(data_room_hotel_list, i){
    ...
    for(j in data_room_hotel_list.rooms){
        if(idx == 0){
            ...
            text+= '<h5 class="name_room" style="margin-bottom:5px;" + title=' + title_name_room + '>' + show_name_room +'</h5><span class="qty_room">Total Room(s): '+ data_room_hotel_list.rooms.length + '</span>';
            ...
            if(data_room_hotel_list.meal_type != "" && data_room_hotel_list.meal_type != undefined){
                text+= '<span class="meal_room"><b>Meal Type: </b> <span>' + data_room_hotel_list.meal_type+'</span></span><br/>';
            }

            text+= '<span style="font-weight:500; padding-top:10px;"><b>Cancellation: </b></span><ul><li id="js_cancellation_button'+i+'" style="color:'+color+'; cursor:pointer; list-style-type:unset; font-weight:400;"><span class="carrier_code_template" onclick="hotel_cancellation_button('+i+','+ data_room_hotel_list.price_code +');"><i class="fas fa-question-circle"></i> See Cancellation Policy</span></li></ul><br/>';
            text+=`
            ...
            if(idx == 0){
                ...
                if(data_room_hotel_list.currency != 'IDR'){
                    ...
                    text+= '<span class="price_room" style="font-weight: bold; font-size:14px;">' + data_room_hotel_list.currency + ' ' + data_room_hotel_list.total +'</span><br/><span class="copy_total_rn carrier_code_template" style="font-size:12px;">(for '+total_room+' room, '+total_night+' night)</span><br/>';
                }else{
                    if(data_room_hotel_list.total != data_room_hotel_list.total_without_discount)
                    ...
                    text+= '<span class="price_room" style="font-weight: bold; font-size:14px;">' +  data_room_hotel_list.currency + ' ' + getrupiah(data_room_hotel_list.total)+'</span><br/><span class="copy_total_rn carrier_code_template" style="font-size:12px;">(for '+total_room+' room, '+total_night+' night)</span><br/>';
                }
        ...
        //            }
                ...
                if (data_room_hotel_list.availability == 'available'){
                    if(hotel_room_detail_pick != null  && hotel_room_detail_pick == i){
                        text+=`<button class="primary-btn-custom-un" style="margin-bottom:unset; margin-top:10px;" type="button" onclick="hotel_room_pick(`+i+`,`+j+`);" id="button`+i+`">Chosen</button>`;
                    }else{
                        text+=`<button class="primary-btn-custom" style="margin-bottom:unset; margin-top:10px;" type="button" onclick="hotel_room_pick(`+i+`,`+j+`);" id="button`+i+`">Choose</button>`;
                    }
                } else {
                    text+=`<button class="primary-btn-custom-un" style="margin-bottom:unset; margin-top:10px;" type="button" style="color:green;" disabled="1"><i class="fa fa-phone-alt" style="margin-top:5px;"/> On Request</button>`;
                }
                idx = 1;
            }
            text+='</div></div>';
