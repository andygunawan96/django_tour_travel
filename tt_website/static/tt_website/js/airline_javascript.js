    ...
    if (airline.length == 0 && count == airline_choose && airline_choose != 0){
                               ...
                               <div class="row" style="padding:10px;">
                                            ...
                                            <div class="col-lg-12" id="copy_div_airline`+i+``+j+`">
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-lg-2" style="padding-top:10px;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12" id="copy_provider_operated`+i+``+j+`">`;
                                                                if(j != 0){
                                                                ...
                                                                <table style="width:100%">
                                                                    <tr>
                                                                        ...
                                                                        <td style="padding-left:15px;">
                                                                            <img src="/static/tt_website/img/icon/airlines-01.png" style="width:20px; height:20px; margin-top:5px;"/>
                                                                        </td>
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
                                                            <table style="width:100%">
                                                                <tr>
                                                                    ...
                                                                    <td style="padding-left:15px;">
                                                                        <img src="/static/tt_website/img/icon/airlines-01.png" alt="Airline" style="width:20px; height:20px; margin-top:5px;"/>
                                                                    </td>
                                                                    <td style="height:30px;padding:0 15px;width:100%">
                                                                        <div style="display:inline-block;position:relative;width:100%">
                                                                            <div style="height:2px;position:absolute;top:16px;width:100%;background-color:#d4d4d4;"></div>
                                                                ...
                                                                <div class="col-xs-12">`;
                                                                    if(airline[i].available_count != 0){
                                                                        if(airline[i].available_count > 9){
                                                                            text += `<img src="/static/tt_website/img/icon/seat.png" style="height:16px; width:auto;"/><span id='airline_seat_left`+i+`'>`+airline[i].available_count+` seats available</span>`;
                                                                        }else{
                                                                            text += `<img src="/static/tt_website/img/icon/seat.png" style="height:16px; width:auto;"/><span id='airline_seat_left`+i+`' style="color:#fc2617;">`+airline[i].available_count+` seats left </span>`;
                                                                        }
                                   ...
                                   <div class="col-lg-6 col-md-6 col-sm-6" style="padding-bottom:10px; margin-top: 15px;">`;
                                       if(provider_list_data[airline[i].provider].is_post_issued_reschedule)
                                            text+=`<span style="font-weight:bold; padding-right:5px;"><i class="fas fa-check-circle" style="color:#4f9c64;"></i> Reschedule</span>`;
        ...
        //                                            <span style="font-weight:bold; padding-right:5px;"><i class="fas fa-check-circle" style="color:#4f9c64;"></i> Refund</span>`;
                                   ...
                                   <div class="col-lg-6 col-md-6 col-sm-6 mt-2" style="text-align:right;">
                                       <span id="fare_no_discount`+i+`" class="basic_fare_field cross_price" style="font-size:14px; color:#929292;"></span><br/>
                                           ...
                                           <div class="col-lg-12">
                                               <div class="row">
                                                   <div class="col-lg-12" style="padding-top:10px;">
                                                        ...
                                                        <div class="input-container-search-ticket btn-group">
                                                            <button style="text-align:left; width:unset; line-height:20px; margin-bottom:0px; font-size:13px; height:50px;" id="show_choose_seat`+i+``+j+`" type="button" class="form-control primary-btn-white dropdown-toggle" data-toggle="dropdown">
                                                                 <span id="choose_seat_span`+i+``+j+`"></span>
                                                            </button>`;
                                                                       ...
                                                                       if(airline_pick_list.length == 0 || airline_recommendations_dict == {} || airline_recommendations_dict.hasOwnProperty(airline[i].journey_ref_id)){
                                                                            ...
                                                                            if(print == true){
                                                                                ...
                                                                                if(airline_request.adult + airline_request.child > airline[i].segments[j].fares[k].available_count){
                                                                                   ...
                                                                                   text+=`<span class="checkmark-radio"></span></label>`;
                                                                                }
                                                                                text+=`</div>`;
                                                                            }
                                                                       }
                                                                           ...
                                                                           <label class="radio-button-custom">
                                                                               ...
                                                                               text+=`</span> / <span style="font-size:14px;">seat left: `+airline[i].segments[j].fares[k].available_count;
                                                                               if(airline_request.adult + airline_request.child > airline[i].segments[j].fares[k].available_count)
...
//                    }
                    ...
                    if(provider_list_data.hasOwnProperty(airline_pick_list[i].provider) == true && provider_list_data[airline_pick_list[i].provider].description != '')
                        text += `<br/><span style="margin-right:5px;">`+provider_list_data[airline_pick_list[i].provider].description+`</span><br/>`;
                        ...
                        for(j in airline_pick_list[i].segments){
                            if(airline_pick_list[i].segments[j].transit_duration != ''){
                                ...
                                <div class="col-lg-12 mt-3" style="text-align:center;padding:0px 15px;">
                                    <div style="border:1px solid #cdcdcd; background:#f7f7f7; padding:15px; border-radius:14px; color:`+color+`;">
                            ...
                            <div class="col-lg-12">
                                <div class="row" id="journeypick0segment0">
                                            ...
                                            if(k == 0){
                                                for(l in airline_pick_list[i].segments[j].fares[k].fare_details){
                                                    if(airline_pick_list[i].segments[j].fares[k].fare_details[l].detail_type.includes('BG')){
                                                        text+=`<span style="font-weight:500;"><i class="fas fa-suitcase"></i> `+airline_pick_list[i].segments[j].fares[k].fare_details[l].amount+` `+airline_pick_list[i].segments[j].fares[k].fare_details[l].unit+`</span><br/>`;
                                                    }
                                                }
                                                break;
                                            }
                                    ...
                                    <div class="col-lg-12" style="padding-top:10px;">
                                        <h6><img src="/static/tt_website/img/icon/seat.png" style="height:16px; width:auto;">Seat Class</h6>

                                        <div class="input-container-search-ticket btn-group">
                                            <button style="text-align:left; width:unset; line-height:20px; margin-bottom:0px; font-size:13px; height:50px;" id="show_choose_seat_pick`+i+``+j+`" type="button" class="form-control primary-btn-white dropdown-toggle" data-toggle="dropdown">
                                                <span id="choose_seat_span_pick`+i+``+j+`"></span>
                                            </button>`;

                                            text+=`<ul id="provider_seat_content_pick`+i+``+j+`" class="dropdown-menu" style="background:unset; z-index:5; border:unset;">`;
                                                        ...
                                                        <div class="col-lg-12">`;
                                                            if(k==airline_pick_list[i].segments[j].fare_pick){
                                                                ...
                                                                <label class="radio-button-custom">
                                                                    ...
                                                                    text+=`</span> / <span style="font-size:14px;">seat left: `+airline_pick_list[i].segments[j].fares[k].available_count+`
                    ...
                    //                                        }
                                                           ...
                                                           if(total_price == 0){
                                                               if(airline_request.adult + airline_request.child > airline_pick_list[i].segments[j].fares[k].available_count){
                                                                    ...
                                                                    if(k==airline_pick_list[i].segments[j].fare_pick){
                                                                        text+=`<br/><span>Price: </span><span id="journeypick`+airline_pick_list[i].airline_pick_sequence+`segment`+j+`fare`+k+`" class="price_template" style="font-weight:bold;">`+airline_pick_list[i].currency+` `+getrupiah(total_price)+`</span>`;
                                                                    }else{
                                                           ...
                                                           if(airline_pick_list[i].segments[j].fares[k].description.length != 0){
                                                                ...
                                                                for(l in airline_pick_list[i].segments[j].fares[k].description){
                                                                    text += `<span style="font-size:13px; display:block;">`+airline_pick_list[i].segments[j].fares[k].description[l]+`</span>`;
    ...
    if(type == ''){
        ...
        //                    $text += price_itinerary_temp[i].journeys[j].segments[k].destination_name + ' (' + price_itinerary_temp[i].journeys[j].segments[k].destination_city + ') '+price_itinerary_temp[i].journeys[j].segments[k].arrival_date +'\n\n';
                            ...
                            if(price_itinerary_temp[i].journeys[j].segments[k].fares.length > 0){
                                text += `<div style="margin-bottom:15px;"><img src="/static/tt_website/img/icon/seat.png" style="height:16px; width:auto;"><span style="font-weight:800;">`;
                                            ...
                                            if(airline_request.adult != 0){
                                                try{
                                                    ...
                                                    if(upsell_price_dict.hasOwnProperty('adult') && i == 0){ //upsell hanya di gunakan di provider pertama
                                                        ...
                                                        commission_price -= upsell_price_dict['adult'];
                                                    }
                                                ...
                                                <div class="row mt-2">
                                                    <div class="col-lg-12">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6" style="text-align:right;">
                                                                <span style="font-size:13px; font-weight:500;">`+airline_price[price_counter].ADT.currency+` `+getrupiah(Math.ceil(price))+`</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                               </div>`;
                                                $text += airline_request.adult + ' Adult @'+ airline_price[price_counter].ADT.currency +' '+getrupiah(Math.ceil(airline_price[price_counter].ADT.fare) + Math.ceil(price/airline_request.adult))+'\n';
//                                                $text += 'Adult Tax '+ airline_price[price_counter].ADT.currency +' '+getrupiah(Math.ceil(price))+'\n';
                                                sub_total_count+=Math.ceil((airline_price[price_counter].ADT.fare * airline_request.adult) +price);
                                                price = 0;
                                            ...
                                            if(airline_request.child != 0){
                                                try{
                                                    ...
                                                    if(upsell_price_dict.hasOwnProperty('child') && i == 0){ //upsell hanya di gunakan di provider pertama
                                                        ...
                                                        commission_price -= upsell_price_dict['child'];
                                                    }
                                                ...
                                                $text += airline_request.child + ' Child @'+ airline_price[price_counter].CHD.currency +' '+getrupiah(Math.ceil(airline_price[price_counter].CHD.fare) + Math.ceil(price/airline_request.child))+'\n';
                                            ...
                                            if(airline_request.infant != 0){
                                                ...
                                                try{
                                                    ...
                                                    if(upsell_price_dict.hasOwnProperty('infant') && i == 0){ //upsell hanya di gunakan di provider pertama
                                                        ...
                                                        commission_price -= upsell_price_dict['infant'];
                                                    }
...
//            }
            ...
            try{
                if(total_discount != 0){
                    ...
                    text+=`</div>`;
                    $text += '‣ Discount: ' + airline_price[0].ADT.currency + ' ' +getrupiah(total_discount*-1) + '\n';
                }
            }catch(err){
                console.log(err); // error kalau ada element yg tidak ada
            }
...
//                grand_total_price += upsell_price;
        ...
        if(document.URL.split('/')[document.URL.split('/').length-2] == 'review' && user_login.co_agent_frontend_security.includes('b2c_limitation') == false && user_login.co_agent_frontend_security.includes("corp_limitation") == false){
            text+=`<div style="text-align:right;"><img src="/static/tt_website/img/bank.png" alt="Bank" style="width:auto; height:25px; cursor:pointer;" onclick="show_repricing();"/></div>`;
        }
        text+=`
        <div class="row">
            <div class="col-lg-12" style="padding-bottom:10px;">
                ...
                if (isMobile) {
                    text+=`
                        <a href="https://wa.me/?text=`+ $text_share +`" data-action="share/whatsapp/share" title="Share by Whatsapp" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Whatsapp" src="/static/tt_website/img/whatsapp.png"/></a>
                        <a href="line://msg/text/`+ $text_share +`" target="_blank" title="Share by Line" style="padding-right:5px;"><img style="height:30px; width:auto;" alt="Line" src="/static/tt_website/img/line.png"/></a>
                        <a href="https://telegram.me/share/url?text=`+ $text_share +`&url=Share" title="Share by Telegram" style="padding-right:5px;"  target="_blank"><img style="height:30px; width:auto;" alt="Telegram" src="/static/tt_website/img/telegram.png"/></a>
                        <a href="mailto:?subject=This is the airline price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Email" src="/static/tt_website/img/email.png"/></a>`;
                } else {
                    text+=`
                        <a href="https://web.whatsapp.com/send?text=`+ $text_share +`" data-action="share/whatsapp/share" title="Share by Whatsapp" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Whatsapp" src="/static/tt_website/img/whatsapp.png"/></a>
                        <a href="https://social-plugins.line.me/lineit/share?text=`+ $text_share +`" title="Share by Line" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Line" src="/static/tt_website/img/line.png"/></a>
                        <a href="https://telegram.me/share/url?text=`+ $text_share +`&url=Share" title="Share by Telegram" style="padding-right:5px;"  target="_blank"><img style="height:30px; width:auto;" alt="Telegram" src="/static/tt_website/img/telegram.png"/></a>
                        <a href="mailto:?subject=This is the airline price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Email" src="/static/tt_website/img/email.png"/></a>`;
                }
            text+=`
        ...
        {
            text +=`<div style="text-align:right; padding-bottom:10px;"><img src="/static/tt_website/img/bank.png" alt="Bank" style="width:auto; height:25px; cursor:pointer;" onclick="show_repricing();"/></div>`;
        }
...
function get_airline_review(){
    ...
    <div style="background:white; margin-bottom:15px; padding:15px; border:1px solid #cdcdcd;">
        <div class="row">
            <div class="col-lg-12 mb-3" style="border-bottom:1px solid #cdcdcd;">
                <h4 class="mb-3"><img src="/static/tt_website/images/icon/airlines_black.png" alt="undefined" style="width:20px; height:20px;"> Flight Detail</h4>
            </div>
        </div>`;
    flight_count = 0;
    for(i in airline_pick){
...
//                                text += `<b>Child - </b>`;
                            ...
                            for(j in passengers_ssr[i].seat_list){
                                ...
                                if(passengers_ssr[i].seat_list[j].seat_pick != ''){
                                    text+= `
                                    • `+passengers_ssr[i].seat_list[j].segment_code+` (`+moment(passengers_ssr[i].seat_list[j].departure_date).format('DD MMM YYYY') +`)<br/><img src="/static/tt_website/img/icon/seat.png" style="height:16px; width:auto;"/> <i>` +passengers_ssr[i].seat_list[j].seat_pick + '</i><br>';
                                }
                                text+=`</b>`;
                            }
                            if(passengers_ssr[i].hasOwnProperty('seat_list')){
                ...
                for(j in passengers_ssr[i].seat_list){
                    try{
                        if(passengers_ssr[i].seat_list[j].seat_pick != ''){
                            ...
                            <img src="/static/tt_website/img/icon/seat.png" style="height:16px; width:auto;"/> <i>`+passengers_ssr[i].seat_list[j].seat_pick + `</i><br/>`;
                        }
                  }catch(err){
                        console.log(err); // error kalau ada element yg tidak ada
                  }
    ...
    <div class="col-lg-12" style="margin-bottom:15px;" id="share_result">
        ...
        if (isMobile) {
            ...
            if(airline_number < 11){
                ...
                text_footer+=`
                <a href="#" target="_blank" title="Share by Line" style="padding-right:5px; cursor:not-allowed;"><img style="height:30px; width:auto;" alt="Line Disable" src="/static/tt_website/img/line-gray.png"/></a>
                <a href="#" title="Share by Telegram" style="padding-right:5px;"  target="_blank"><img style="height:30px; width:auto;" alt="Telegram Disable" src="/static/tt_website/img/telegram-gray.png"/></a>`;
            }
            text_footer+=`
                <a href="mailto:?subject=This is the airline price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Email" src="/static/tt_website/img/email.png"/></a>`;
        } else {
            ...
            if(airline_number < 11){
                ...
                text_footer+=`
                <a href="#" title="Share by Line" style="padding-right:5px; cursor:not-allowed;"><img style="height:30px; width:auto;" alt="Line Disable" src="/static/tt_website/img/line-gray.png"/></a>
                <a href="#" title="Share by Telegram" style="padding-right:5px; cursor:not-allowed;"><img style="height:30px; width:auto;" alt="Telegram Disable" src="/static/tt_website/img/telegram-gray.png"/></a>`;
            }
            text_footer+=`
                <a href="mailto:?subject=This is the airline price detail&amp;body=`+ $text_share +`" title="Share by Email" style="padding-right:5px;" target="_blank"><img style="height:30px; width:auto;" alt="Email" src="/static/tt_website/img/email.png"/></a>`;
        }
