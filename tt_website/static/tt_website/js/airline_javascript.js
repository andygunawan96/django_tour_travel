                       ...
                       if(ticket_count >= first && ticket_count < last){
                           ...
                           <div class="search-box-result" id="journey`+i+`">
                               ...
                               <div class="row" style="padding:10px;">
                                                ...
                                                <div class="col-lg-2">`;
                                                    for(j in airline[i].segments){
                                                        ...
                                                        if(airline[i].segments[j].carrier_code != airline[i].segments[j].operating_airline_code && airline[i].segments[j].operating_airline_code != ''){
                                                            ...
                                                            try{
                                                                text+=`<span class="copy_carrier_provider" style="font-weight:500; font-size:12px;">`+airline_carriers[0][airline[i].segments[j].carrier_code].name+`</span><br/>`;
                                                            }catch(err){
                                                                text+=`<span class="copy_carrier_provider" style="font-weight:500; font-size:12px;">`+airline[i].segments[j].carrier_code+`</span><br/>`;
                                                            }
                                                        ...
                                                        if(airline[i].segments[j].carrier_code != airline[i].segments[j].operating_airline_code && airline[i].segments[j].operating_airline_code != ''){
                                                            try{
                                                                text+=`<img data-toggle="tooltip" style="width:50px; height:50px;" alt="`+airline_carriers[0][airline[i].segments[j].carrier_code].name+`" title="`+airline_carriers[0][airline[i].segments[j].carrier_code].name+`" class="airline-logo" src="`+static_path_url_server+`/public/airline_logo/`+airline[i].segments[j].carrier_code+`.png"><br/>`;
                                                            }catch(err){
                                                                text+=`<img data-toggle="tooltip" style="width:50px; height:50px;" alt="`+airline[i].segments[j].carrier_code+`" title="`+airline[i].segments[j].carrier_code+`" class="airline-logo" src="`+static_path_url_server+`/public/airline_logo/`+airline[i].segments[j].carrier_code+`.png"><br/>`;
                                                            }
                                                        }else if(carrier_code_airline.includes(airline[i].segments[j].carrier_code) == false){
                                                            try{
                                                                text+=`<img data-toggle="tooltip" style="width:50px; height:50px;" alt="`+airline_carriers[0][airline[i].segments[j].carrier_code].name+`" title="`+airline_carriers[0][airline[i].segments[j].carrier_code].name+`" class="airline-logo" src="`+static_path_url_server+`/public/airline_logo/`+airline[i].segments[j].carrier_code+`.png"><br/>`;
                                                        ...
                                                        try{
                                                            text+=`<span class="carrier_code_template">`+airline[i].segments[j].carrier_name+`</span><br/>`;
                                                        }catch(err){}
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            if(airline[i].available_count != 0){
                                                                if(airline[i].available_count > 9){
                                                                    text += `<img src="/static/tt_website/images/icon/symbol/seat.png" style="height:16px; width:auto;"/><span id='airline_seat_left`+i+`'>`+airline[i].available_count+` seats available</span>`;
                                                                }else{
                                                                    text += `<img src="/static/tt_website/images/icon/symbol/seat.png" style="height:16px; width:auto;"/><span id='airline_seat_left`+i+`' style="color:#fc2617;">`+airline[i].available_count+` seats left </span>`;
                                                                }
                                   ...
                                   text+=`
                                   <div class="col-lg-4 col-md-4" style="padding-bottom:10px; margin-top: 15px;">`;
...
//                                            <span style="font-weight:bold; padding-right:5px;"><i class="fas fa-check-circle" style="color:#4f9c64;"></i> Refund</span>`;
                                   ...
                                   <div class="col-lg-8 col-md-8" style="text-align:right;">
                                       <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-7" style="text-align:right; padding-right:0px;">
                                               ...
                                               for(fare_seat_co in airline[i].segments){
                                                   text+=`<span id="fare_seat_class`+i+``+fare_seat_co+`"></span>`;
                               ...
                               <div id="detail_departjourney`+i+`" class="panel-collapse collapse in" aria-expanded="true" style="display:none; background: #ebebeb;">`;
                                   for(j in airline[i].segments){
                                        text+=`
                                        <div id="copy_segments_details`+i+``+j+`">
                                           <span class="copy_segments" hidden>`+i+``+j+`</span>`;
                                           if(airline[i].segments[j].transit_duration != ''){
                                               text += `<div class="col-lg-12" style="text-align:center;padding:0px 15px;"><div style="border:1px solid #cdcdcd; background:white; padding:15px; border-radius:14px; color:`+color+`;"><i class="fas fa-clock"></i><span style="font-weight:500" class="copy_transit_details">Transit Duration: `;
    ...
    //                                       }
                                               ...
                                               <div class="col-lg-12">
                                                   <div class="row">
                                                       <div class="col-lg-12" style="padding-top:10px;">
                                                            ...
                                                            <div class="input-container-search-ticket btn-group">
                                                                <button style="text-align:left; width:100%; line-height:20px; margin-bottom:0px; font-size:13px; height:50px;" id="show_choose_seat`+i+``+j+`" type="button" class="form-control primary-btn-white dropdown-toggle" data-toggle="dropdown">
                                                                     <span id="choose_seat_span`+i+``+j+`"></span>
                                                                </button>`;

                                                                //mark class of service search
                                                                text+=`
                                                                <ul id="provider_seat_content`+i+``+j+`" class="dropdown-menu" style="background:white; z-index:5; border:unset; padding:15px; border:1px solid #cdcdcd;">
                                                                   <div class="row">
                                                                       <div class="col-lg-12">
                                                                            <h6 class="mb-3">Class of Service</h6>
                                                                       </div>
                                                                       <div class="col-lg-12">
                ...
                //                                                                   text+=`</label></div>`;
                                   ...
                                   text+=`
                                   <div class="col-lg-12" style="background:white; padding-top:10px; padding-bottom:15px">
                                       <div class="row">
                                            <div class="col-lg-9 col-md-9 col-sm-8 col-xs-6" style="text-align:right; padding-right:0px;">
                                               <div style="display:inline-block; padding-right:10px;">
                                                   <span id="fare_no_discount_fd`+i+`" class="basic_fare_field cross_price" style="font-size:14px; color:#929292;"></span><br/>
                                               ...
                                               for(fare_seat_co in airline[i].segments){
                                                   text+=`<span id="fare_seat_class_fd`+i+``+fare_seat_co+`"></span>`;
                                                   if(fare_seat_co != airline[i].segments.length-1){
                                                       text+=`<br/>`;
                                                   }
                                               }
                                           ...
                                           <div class="col-lg-3 col-md-3 col-sm-4 col-xs-6" style="text-align:right;">`;
                                               if(airline[i].can_book == true && airline[i].can_book_check_arrival_on_next_departure == true){
                            ...
                            if(airline_request.origin.length == airline_pick_list.length + 1 && airline_recommendations_list.length != 0){
                                ...
                                if(airline[i].total_price != 0){
                                    ...
                                    if(total_discount != 0){
                                        ...
                                        try{
                                            document.getElementById('fare_no_discount_fd'+i).innerHTML = airline[i].currency+' '+getrupiah(airline[i].total_price + total_discount);
                                        }catch(err){}
                                    }
    ...
    for(i in airline_pick_list){
        ...
        <div style="background-color:white; border:1px solid `+color+`; margin-bottom:15px; padding:15px 15px 0px 15px;;" id="journey2`+airline_pick_list[i].airline_pick_sequence+`">
            <div class="row">
                ...
                text+=`
                <div class="col-lg-4 col-md-4" style="text-align:left; padding-top:15px;">
                ...
                <div class="col-lg-8 col-md-8" style="text-align:right; margin-top: 15px;">
                    <div class="row">`;
                    price = 0;
    ...
    //                    }
                        ...
                        <div class="col-lg-7 col-md-6">
                            ...
                            <div style="display:inline-block;">`;
                                for(fare_seat_co in airline_pick_list[i].segments){
                                    text+=`<span id="fare_seat_class_pick`+i+``+fare_seat_co+`"></span>`;
                        ...
                        <div class="col-lg-5 col-md-6 mb-1">
                            ...
                            if(type == 'all'){
                                text+=`
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%;" id="deletejourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Delete" onclick="delete_mc_journey(`+airline_pick_list[i].airline_pick_sequence+`);" sequence_id="0"/>
                                </div>
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%;" id="changejourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Change" onclick="change_departure(`+airline_pick_list[i].airline_pick_sequence+`);" sequence_id="0"/>
                                </div>`;
                            }
                            else if(type == 'change'){
                                text+=`
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%; background:#cdcdcd !important;" id="deletejourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Delete" onclick="delete_mc_journey(`+airline_pick_list[i].airline_pick_sequence+`);" disabled sequence_id="0"/>
                                </div>
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%;" id="changejourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Change" onclick="change_departure(`+airline_pick_list[i].airline_pick_sequence+`);" sequence_id="0"/>
                                </div>`;
                                ...
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%; background:#f5f5f5 !important;" id="changejourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Change" onclick="change_departure(`+airline_pick_list[i].airline_pick_sequence+`);" disabled sequence_id="0"/>
                                </div>`;
                            }
                            else if(type=='no_button'){
                                text+=`
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%; background:#cdcdcd !important;" id="deletejourney_pickdepartjourney`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Delete" onclick="delete_mc_journey(`+airline_pick_list[i].airline_pick_sequence+`);" disabled sequence_id="0"/>
                                </div>
                                <div class="col-xs-6">
                                    <input type='button' style="width:100%; background:#cdcdcd !important;" id="changejourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="primary-btn-custom choose_selection_ticket_airlines_depart" value="Change" onclick="change_departure(`+airline_pick_list[i].airline_pick_sequence+`);" disabled sequence_id="0"/>
                                </div>`;
                            }
                            text+=`
                            </div>
                ...
                <div id="detail_departjourney_pick`+airline_pick_list[i].airline_pick_sequence+`" class="panel-collapse collapse in" aria-expanded="true" style="display:none; background: #ebebeb; padding:10px;">
                    <div class="row">`;
                    for(j in airline_pick_list[i].segments){
                        if(airline_pick_list[i].segments[j].transit_duration != ''){
                            text += `
                            <div class="col-lg-12 mt-3" style="text-align:center;padding:0px 15px;">
                                <div style="border:1px solid #cdcdcd; background:white; padding:15px; border-radius:14px; color:`+color+`;">
...
//                            }
                        ...
                        <div class="col-lg-12">
                            <div class="row" id="journeypick0segment0">
                                ...
                                <div class="col-lg-12" style="padding-top:10px;">
                                    <h6><img src="/static/tt_website/images/icon/symbol/seat.png" style="height:16px; width:auto;">Seat Class</h6>

                                    <div class="input-container-search-ticket btn-group">
                                        <button style="text-align:left; width:100%; line-height:20px; margin-bottom:0px; font-size:13px; height:50px;" id="show_choose_seat_pick`+i+``+j+`" type="button" class="form-control primary-btn-white dropdown-toggle" data-toggle="dropdown">
                                             <span id="choose_seat_span_pick`+i+``+j+`"></span>
                                        </button>`;

                                        //mark class of service search choose
                                        text+=`
