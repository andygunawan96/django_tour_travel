...
function get_zip_code(){
    $.ajax({
       ...
       error: function(XMLHttpRequest, textStatus, errorThrown) {
            console.log('Error get config data medical')
//            error_ajax(XMLHttpRequest, textStatus, errorThrown, 'Error get config medical');
       },timeout: 300000
    });
}
...
//                    document.getElementById('new-reservation').hidden = false;
                    ...
                    if(msg.result.response.state == 'booked'){
                       check_payment_payment_method(msg.result.response.order_number, 'Issued', msg.result.response.booker.seq_id, 'billing', 'medical', signature, msg.result.response.payment_acquirer_number, msg);
