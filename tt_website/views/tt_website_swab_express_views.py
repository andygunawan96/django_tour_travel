    ...
    if 'user_account' in request.session._session and 'ticketing_swabexpress' in request.session['user_account']['co_agent_frontend_security']:
        try:
            ...
            values.update({
                ...
                'big_banner_value': check_banner('swabexpress', 'big_banner', request),
                'small_banner_value': check_banner('swabexpress', 'small_banner', request),
...
def booking(request, order_number):
    try:
        ...
        if 'user_account' not in request.session and 'btc' in web_mode:
            ...
            raise Exception('Swab Express get booking without login in btb web')
        try:
