            ...
            for i in range(int(insurance_request_with_passenger['adult'])):
                ...
                for j in range(int(insurance_request_with_passenger['family']['adult'])):
                    ...
                    relation.append({
                        ...
                        "first_name": first_name,
                        "last_name": last_name,
                        "nationality_code": request.POST['Adult_relation%s_nationality%s' % (str(i + 1),counter) + '_id'],
                ...
                for j in range(int(insurance_request_with_passenger['family']['child'])):
                    ...
                    relation.append({
                        ...
                        "first_name": first_name,
                        "last_name": last_name,
                        "nationality_code": request.POST['Child_relation%s_nationality%s' % (str(i + 1), counter) + '_id'],
                ...
                if insurance_pick['provider'] == 'bcainsurance':
                    if request.POST['Adult_relation_beneficiary_first_name' + str(i + 1)]:
                        ...
                        ahli_waris.update({
                            ...
                            "first_name": first_name,
                            "last_name": last_name,
                            "nationality_code": request.POST['Adult_relation_beneficiary_nationality' + str(i + 1) + '_id'],
