    ...
    <div class="col-lg-12" id="mc_airline`+counter+`">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6" style="padding:0px;">
                ...
                <input type="hidden" class="form-control date-picker airline_return" name="airline_return`+counter+`" id="airline_return`+counter+`" placeholder="Return Date " onfocus="this.placeholder = ''" onblur="this.placeholder = 'Return Date '" autocomplete="off">
            </div>
