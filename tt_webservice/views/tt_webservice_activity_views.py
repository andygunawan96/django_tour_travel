...
def get_pricing(request):
    ...
    data = {
        ...
        'date_start': datetime.strptime(startingDate, '%d %b %Y').strftime('%Y-%m-%d %H:%M:%S')[:10],
        'date_end': (datetime.strptime(startingDate, '%d %b %Y')+timedelta(days=pricing_days)).strftime('%Y-%m-%d %H:%M:%S')[:10],
