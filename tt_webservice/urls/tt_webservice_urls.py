...
from ..views import tt_webservice_swab_express_views as SwabExpressWebserviceView
...
from ..views import tt_webservice_sentra_medika_views as SentraMedikaWebserviceView
from ..views import tt_webservice_group_booking_views as GroupBookingWebserviceView
...
urlpatterns = [
    ...
    re_path('swab_express', SwabExpressWebserviceView.api_models, name="swab_express"),
    re_path('lab_pintar', LabPintarWebserviceView.api_models, name="lab_pintar"),
    ...
    re_path('sentra_medika', SentraMedikaWebserviceView.api_models, name="sentra_medika"),
    re_path('group_booking', GroupBookingWebserviceView.api_models, name="group_booking"),
    # url(r'^$', views.index),
]
