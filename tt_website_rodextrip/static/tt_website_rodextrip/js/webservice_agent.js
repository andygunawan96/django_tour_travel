...
function get_payment_espay(){
    getToken();
    bank_code = '';
    var radios = document.getElementsByName('bank_code');
    for (var j = 0, length = radios.length; j < length; j++) {
        if (radios[j].checked) {
            bank_code = document.getElementsByName('bank_code')[j].value
            break;
        }
    }
    merchant_pick = {};
    for(i in merchant_espay.result.response){
        if(merchant_espay.result.response[i].bankCode == bank_code){
            merchant_pick = merchant_espay.result.response[i];
            break;
        }
    }
    if(bank_code != ''){
        $.ajax({
           ...
           data: {
                ...
                "bank_code": bank_code,
                "bank_name": merchant_pick.productName
           },
           success: function(msg) {
                console.log(msg);
                if(msg.result.error_code == 0){
                    text = '';
                    text = `<h3 style="" class="text-center">PEMBAYARAN ANDA BELUM SELESAI</h3>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="panel panel-n">
                                    <div class="panel-body-n">
                                        `+getrupiah(parseInt(msg.result.response.total_amount))+`

                                    </div>
                                </div>

                                <p class="label-total">Nomor VA</p> <span class="sub-label">Account Number</span>

                                <div class="panel panel-default">
                                    <div class="panel-body-n">
                                        `+msg.result.response.va_number+`
                                    </div>
                                </div>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body-n">
                                        `+msg.result.response.expired+`
                                    </div>
                                </div>
                            </div>`;
                            if(merchant_pick.productName == 'BCA VA Online'){
                            text+=`
                            ...
                            }else if(merchant_pick.productName == 'MANDIRI VA'){
                            text+=`
                            <div style="margin-left: 20px;margin-right: 20px;">
                            <div class="row">
                                <div style="margin-left: 20px;">
                                    <h4>Instruksi Pembayaran ATM Transfer</h4>
                                    <span class="sub-label-header">ATM Transfer Payment Instruction</span>
                                </div>
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                                    <div class="panel panel-default">
                                        <div class="panel-heading-sgo" role="tab" id="headingOne">
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-1.png">
                                                            <p>Gunakan mesin ATM MANDIRI atau berlogo ATM BERSAMA / Alto</p>
                                                        </div>

                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-2.png">
                                                            <p>Pada menu utama, pilih Transaksi Lainnya</p>
                                                        </div>

                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-3.png">
                                                            <p>Pilih Transfer</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-4.png">
                                                            <p>Pilih Antar Bank Online</p>
                                                        </div>

                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-5.png">
                                                            <p>Masukkan nomor 008 dan 3425665094928038</p>
                                                        </div>

                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-6.png">
                                                            <p>Masukkan jumlah tagihan yang akan anda bayar secara lengkap 1.697.120 (Pembayaran dengan jumlah tidak sesuai akan otomatis ditolak)</p>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-7.png">
                                                            <p>Kosongkan No. Referensi, lalu tekan Benar</p>
                                                        </div>
                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-8.png">
                                                            <p>Pada halaman konfirmasi transfer akan muncul jumlah yang dibayarkan, nomor rekening, &amp; nama Merchant. Jika informasi telah sesuai tekan Benar</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            <div class="panel-body">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-1.png">
                                                        <p>Gunakan mesin ATM BCA atau berlogo PRIMA</p>
                                                    </div>

                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-2.png">
                                                        <p>Pada menu utama, pilih Transaksi Lainnya</p>
                                                    </div>

                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-3.png">
                                                        <p>Pilih Transfer</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-4.png">
                                                        <p>Pilih Rek Bank Lain</p>
                                                    </div>

                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-5.png">
                                                        <p>Masukkan KODE BANK  008 lalu tekan Lanjut / Benar</p>
                                                    </div>

                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-6.png">
                                                        <p>Masukkan jumlah tagihan yang akan anda bayar secara lengkap 1.697.120 (Pembayaran dengan jumlah tidak sesuai akan otomatis ditolak)</p>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-7.png">
                                                        <p>Masukkan 16 digit No. Rekening pembayaran 3425665094928038 lalu tekan Benar</p>
                                                    </div>

                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-8.png">
                                                        <p>Pada halaman konfirmasi transfer akan muncul jumlah yang dibayarkan, nomor rekening, &amp; nama Merchant. Jika informasi telah sesuai tekan Benar</p>
                                                    </div>
                        ...
                        }else if(merchant_pick.productName == 'PERMATA VA'){
                            text+=`<div style="margin-left: 20px;margin-right: 20px;">
                            <div class="row">
                                <div style="margin-left: 20px;">
                                    <h4>Instruksi Pembayaran ATM Transfer</h4>
                                    <span class="sub-label-header">ATM Transfer Payment Instruction</span>
                                            ...
                                            <div class="panel-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12">
                                                        ...
                                                        <div class="col-sm-4 col-md-4 col-lg-4">
                                                            <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmbersama-5.png">
                                                            <p>Masukkan nomor 013 dan 8620004589288458</p>
                                                        </div>
                                        ...
                                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                                            <div class="panel-body">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    ...
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-5.png">
                                                        <p>Masukkan KODE BANK  013 lalu tekan Lanjut / Benar</p>
                                                    </div>
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmprima-7.png">
                                                        <p>Masukkan 16 digit No. Rekening pembayaran 8620004589288458 lalu tekan Benar</p>
                                                    </div>
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                            <div class="panel-body">
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-1.png">
                                                        <p>Gunakan mesin ATM BANK PERMATA</p>
                                                    </div>
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-2.png">
                                                        <p>Pilih Other Transaction</p>
                                                    </div>
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-3.png">
                                                        <p>Pilih Payment</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-4.png">
                                                        <p>Pilih Other Payment</p>
                                                    </div>
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-5.png">
                                                        <p>Masukan 16 Digit Nomor Pemayaran 8620004589288458, lalu Pilih Correct</p>
                                                    </div>
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-6.png">
                                                        <p>Informasi pembayaran akan tertera dan pilih Correct</p>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12 col-md-12 col-lg-12">
                                                    <div class="col-sm-4 col-md-4 col-lg-4">
                                                        <img class="img-thumbnail" src="/static/tt_website_rodextrip/images/espay/step-atmalto-7.png">
                                                        <p>Pilih Akun Pembayaran dan Pilih Correct</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        Swal.fire({
          type: 'error',
          title: 'Oops!',
          html: '<span style="color: red;">Error </span>Please choose payment method' ,
        })
    }
}
