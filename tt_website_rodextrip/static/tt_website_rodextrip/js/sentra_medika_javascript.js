                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-6">
                                    <div class="form-select">
                                        <select id="train_`+(counter_passenger+1)+`_search_type" name="train_`+(counter_passenger+1)+`_search_type" onchange="search_type_on_change('train_`+(counter_passenger+1)+`_search_type','train_passenger_search');">
