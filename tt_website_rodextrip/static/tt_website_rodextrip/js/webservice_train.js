                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 mb-2">
                                                            ...
                                                            {
                                                                text += `<tr>
                                                                    <td><span id="resv_pax_value`+resv_pax+`">`+train_get_detail.result.response.passengers[resv_pax].name+`, `+train_get_detail.result.response.passengers[resv_pax].title+`</span></td>
