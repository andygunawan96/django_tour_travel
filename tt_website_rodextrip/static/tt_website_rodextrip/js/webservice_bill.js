...
//            get_carriers_ppob();
            ...
            for(i in ppob_data.product_data){
                ...
                text+=`
                    ...
                    if(i == 'bpjs'){
                        text+=`<img src="/static/tt_website_rodextrip/images/icon/bpjs.png" alt="BPJS" style="width:60px; height:60px;"><br/>`;
                    }else if(i == 'pln'){
                        text+=`<img src="/static/tt_website_rodextrip/images/icon/pln.png" alt="PLN" style="width:60px; height:60px;"><br/>`;
                    }
...
function bills_next(){
    ...
    if(user_login.co_agent_frontend_security.includes('b2c_limitation')){
        ...
        document.getElementById('bills_issued').submit();
    }else{
        ...
        document.getElementById('bill_searchForm').action = '/bills/booking/' + btoa(bill_response.result.response.order_number);
        document.getElementById('bill_searchForm').submit();
    }

}

function bills_get_booking(data){
    price_arr_repricing = {};
                ...
                <div style="background-color:white; border:1px solid #cdcdcd;">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <h5> Bills Detail <img style="width:18px;" src="/static/tt_website_rodextrip/images/icon/plane.png" alt="Bills Detail"/></h5>
                            <hr/>`;
                        check = 0;
                        flight_counter = 1;
                        for(i in msg.result.response.provider_booking){
