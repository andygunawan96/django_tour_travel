    ...
    $.ajax({
       ...
       success: function(msg) {
            if(msg.result.error_code == 0){
                ...
                document.getElementById('header').innerHTML = `<h3 style="text-align:center;color:`+color+`">`+msg.result.response.title+`</h3><img src="`+msg.result.response.image_carousel+`" style="height:300px;" alt="" title="" />`;
