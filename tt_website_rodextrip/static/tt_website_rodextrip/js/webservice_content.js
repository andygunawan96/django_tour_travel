    ...
    $.ajax({
       ...
       success: function(msg) {
            if(msg.result.error_code == 0){
                ...
                document.getElementById('header_page').innerHTML = `<img src="`+msg.result.response.image_carousel+`" style="max-height:100%;max-width:100%;" alt="`+msg.result.response.title+`" title="" />`;
            }else{
