...
function get_area_global(){
    ...
    if(test_type.includes('PHCHC')){
        ...
        $('html, body').animate({
            scrollTop: $("#div_schedule_mitra_keluarga").offset().top - 110
        }, 500);
    }
}
...
function regex_phone_mitra_keluarga(value){
  var regex_check = "^[1-9][0-9]*$";//number
    if(value.match(regex_check)!=null){
        ...
        value = regex_phone_mitra_keluarga(value.slice(1,value.length));
        return value;
    }
}
...
function onchange_number_no_zero(val){
    if(document.getElementById('adult_phone'+val).value != '' && document.getElementById('adult_phone'+val).value != undefined){
        var data = regex_phone_mitra_keluarga(document.getElementById('adult_phone'+val).value)
...
//                }
    ...
    //       re_medical_signin('next');
           ...
           if(check_scroll == "booker"){
                ...
                $('html, body').animate({
                    scrollTop: $("#mitra_keluarga_pax_div").offset().top - 120
                }, 500);
           }else{
                $('html, body').animate({
...
function add_table(change_rebooking=false){
    ...
    if(change_rebooking == true && total_passengers_rebooking != 0){
        ...
        // isi data passenger
        get_data_cache_passenger_mitra_keluarga();
        get_data_cache_schedule_mitra_keluarga();
...
function add_table_verify(change_rebooking=false){
    ...
    if(change_rebooking == true && total_passengers_rebooking != 0){
        ...
        last_counter = tempcounter;
        // isi data
        get_data_cache_passenger_mitra_keluarga('verify');
    }
    last_counter = tempcounter;
}
