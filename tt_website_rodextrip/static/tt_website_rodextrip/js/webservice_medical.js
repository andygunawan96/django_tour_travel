                    ...
                    text+=`
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                text+=`<span>Date: <b>`;
                                if(msg.result.response.provider_booking[0].carrier_code == 'PHCHCKATG' || msg.result.response.provider_booking[0].carrier_code == 'PHCHCKPCR' || msg.result.response.provider_booking[0].carrier_code == "PRKATG")
