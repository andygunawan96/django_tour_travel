            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        ...
                        if(total_discount != 0)
                            text_detail_next+=`<span style="font-size:12px; color:#cdcdcd;text-decoration: line-through;">`+airline_price[0].ADT.currency+` `+getrupiah(Math.ceil(total_price))+`</span>`;
