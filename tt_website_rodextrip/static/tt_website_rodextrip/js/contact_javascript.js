       ...
       success: function(msg) {
            if(type == 'setting'){
                ...
                for(i in msg){
                    ...
                    if(msg[i][0] == "Phone"){
                        text+=`<img style="margin-bottom:10px; height:40px; width:auto; padding-right:10px;" src="/static/tt_website_rodextrip/img/phone.png"/><span style="position:absolute;">`;
                        text+=``+msg[i][0]+``;
                        if(msg[i][2] != ''){
                            text+=`<br/><b>`+msg[i][2]+`: </b>`;
                        }
                        ...
                        text+=`<img style="margin-bottom:10px; height:43px; width:auto; padding-right:5px;" src="/static/tt_website_rodextrip/img/whatsappic.png"/><span style="position:absolute;">`;
                        text+=``+msg[i][0]+``;
                        if(msg[i][2] != ''){
                            text+=`<br/><b>`+msg[i][2]+`: </b>`;
                        }
                        ...
                        text+=`<img style="margin-bottom:10px; height:43px; width:auto; padding-right:10px;" src="/static/tt_website_rodextrip/img/line.png"/><span style="position:absolute;">`;
                        text+=``+msg[i][0]+``;
                        if(msg[i][2] != ''){
                            text+=`<br/><b>`+msg[i][2]+`: </b>`;
                        }
                        ...
                        text+=`<img style="margin-bottom:10px; height:40px; width:auto; padding-right:10px;" src="/static/tt_website_rodextrip/img/telegram.png"/><span style="position:absolute;">`;
                        text+=``+msg[i][0]+``;
                        if(msg[i][2] != ''){
                            text+=`<br/><b>`+msg[i][2]+`: </b>`;
                        }
                        ...
                        text+=`<img style="margin-bottom:10px; height:40px; width:auto; padding-right:10px;" src="/static/tt_website_rodextrip/img/email.png"/><span style="position:absolute;">`;
                        text+=``+msg[i][0]+``;
                        if(msg[i][2] != ''){
                            text+=`<br/><b>`+msg[i][2]+`: </b>`;
                        }
                        ...
                        text+=`<img style="margin-bottom:10px; height:40px; width:auto; padding-right:10px;" src="/static/tt_website_rodextrip/img/other.png"/><span style="position:absolute;">`;
                        text+=``+msg[i][0]+``;
                        if(msg[i][2] != ''){
                            text+=`<br/><b>`+msg[i][2]+`: </b>`;
                        }
